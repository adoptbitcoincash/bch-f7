<ListItem link={`/accounts/${account.id}/nonFungibleTokenVariations/${nonFungibleTokenVariation.id}/nonFungibleTokens/${nonFungibleToken.id}`} on:click={clicked}>
...
<script lang="ts">
  ...
  import type { Account, NonFungibleTokenVariation, NonFungibleToken } from "@adoptbitcoincash/bch-orm";
