<div class="nft">
  <div class="visual2">
    <div class="visual"><Link href={`/nonFungibleTokens/nonFungibleTokenVariations/${nonFungibleTokenVariation.id}`}><img src="{nonFungibleTokenVariation.image.cdn}" alt=""/></Link></div>
  </div>
</div>
