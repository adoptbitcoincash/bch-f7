<div class="nft">
  <div class="visual2">
    <div class="visual"><Link href={`/accounts/${account.id}/nonFungibleTokenVariations/${nonFungibleTokenVariation.id}`}><img src="{nonFungibleTokenVariation.image.cdn}" alt=""/></Link></div>
  </div>
</div>
...
<style>
  ...
  .infos {text-align:left; padding-top:5px;}
  .infos .name {font-size: .875rem; font-weight:700; line-height: 1.4; letter-spacing: -.011em;}
  .infos .more {font-size: .75rem; font-weight:600; color:#374047; letter-spacing:-.011em;}
</style>
