<Card>
  <CardContent padding={false}>
    <List medial-list>
      <ListItem link={`/accounts/${account.id}/coins/${coin.id}/tokens/${fungibleTokenBalance.id}`} footer="{fungibleTokenBalance.toString()}" title={fungibleToken.name} after={fiat}>
